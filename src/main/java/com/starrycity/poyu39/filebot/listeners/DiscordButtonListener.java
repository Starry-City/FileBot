...
public class DiscordButtonListener extends ListenerAdapter {
  ...
  public void onButtonInteraction(ButtonInteractionEvent event) {
    switch (Objects.requireNonNull(event.getButton().getId())) {
      case "close":
        ...
        break;
      case "last_page":
        BotCommand.page = BotCommand.page - 1;
        refreshButton(event);
        break;
      case "refresh_page":
        refreshButton(event);
  ...
  public static void refreshButton(ButtonInteractionEvent event) {
    ...
    if (BotCommand.page >= 1 && BotCommand.page < maxPage) {
    ...
    } else if (BotCommand.page < 1 && BotCommand.page < maxPage) {
      controlButtons.add(Button.primary("last_page", Emoji.fromFormatted("U+21A9")).withLabel("上一頁").asDisabled());
      controlButtons.add(Button.primary("refresh_page", Emoji.fromFormatted("U+1F504")).withLabel("重新整理"));
      controlButtons.add(Button.primary("next_page", Emoji.fromFormatted("U+21AA")).withLabel("下一頁"));
    } else if (BotCommand.page == maxPage) {
      controlButtons.add(Button.primary("last_page", Emoji.fromFormatted("U+21A9")).withLabel("上一頁"));
      controlButtons.add(Button.primary("refresh_page", Emoji.fromFormatted("U+1F504")).withLabel("重新整理"));
      controlButtons.add(Button.primary("next_page", Emoji.fromFormatted("U+21AA")).withLabel("下一頁").asDisabled());
    }
    if (buttonRowCount - BotCommand.page * 4 >= 4) {
      event.editMessage("已讀取" + DiscordCommandListener.nowNameOfPlugin + "/" + DiscordCommandListener.nowNameOfFolder + "資料夾 (頁數: " + BotCommand.page + "/" + maxPage + ")")
          .setComponents(
              ActionRow.of(controlButtons),
              ActionRow.of(buttonsRowLists.get(0 + BotCommand.page * 4)),
              ActionRow.of(buttonsRowLists.get(1 + BotCommand.page * 4)),
              ActionRow.of(buttonsRowLists.get(2 + BotCommand.page * 4)),
              ActionRow.of(buttonsRowLists.get(3 + BotCommand.page * 4))
          ).queue();
    } else if (buttonRowCount - BotCommand.page * 4 == 3) {
      event.editMessage("已讀取" + DiscordCommandListener.nowNameOfPlugin + "/" + DiscordCommandListener.nowNameOfFolder + "資料夾 (頁數: " + BotCommand.page + "/" + maxPage + ")")
          .setComponents(
              ActionRow.of(controlButtons),
              ActionRow.of(buttonsRowLists.get(0 + BotCommand.page * 4)),
    ...
    } else if (buttonRowCount - BotCommand.page * 4 == 2) {
      event.editMessage("已讀取" + DiscordCommandListener.nowNameOfPlugin + "/" + DiscordCommandListener.nowNameOfFolder + "資料夾 (頁數: " + BotCommand.page + "/" + maxPage + ")")
          .setComponents(
              ActionRow.of(controlButtons),
              ActionRow.of(buttonsRowLists.get(0 + BotCommand.page * 4)),
    ...
    } else if (buttonRowCount - BotCommand.page * 4 == 1) {
      event.editMessage("已讀取" + DiscordCommandListener.nowNameOfPlugin + "/" + DiscordCommandListener.nowNameOfFolder + "資料夾 (頁數: " + BotCommand.page + "/" + maxPage + ")")
          .setComponents(
              ActionRow.of(controlButtons),
              ActionRow.of(buttonsRowLists.get(0 + BotCommand.page * 4))
